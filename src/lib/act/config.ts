// Auto-generated shim — re-exports from @/lib/cds/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _cds_Config } from "@/lib/cds/config";
import { EXAM_CONFIG as _raw } from "@/lib/cds/config";
