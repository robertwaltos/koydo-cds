...
const EXAM_ID = "cds";
const EXAM_DISPLAY_NAME = "CDS (Combined Defence Services Examination)";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover English, General Knowledge, and Elementary Mathematics (for IMA/INA/AFA). Align to UPSC CDS syllabus.
