...
export const metadata: Metadata = {
  title: "Koydo CDS — Free Exam Prep",
  description: "Comprehensive CDS preparation. Practice tests, AI tutor, score tracking. Study aid only. Not affiliated with official examination boards.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real CDS format." },
